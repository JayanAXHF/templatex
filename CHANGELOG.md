...
## [0.5.3](https://github.com/JayanAXHF/templatex/compare/v0.5.2...v0.5.3) - 2025-12-09

### Fixed

- removed unused import from logging.rs

## [0.5.2](https://github.com/JayanAXHF/templatex/compare/v0.5.1...v0.5.2) - 2025-12-08

### Added

- Added human-panic error hooks for cleaner errors

## [0.5.1](https://github.com/JayanAXHF/templatex/compare/v0.5.0...v0.5.1) - 2025-12-08

### Added

- Add conditional logging to enable tracing info statements when TUI is not running ([#10](https://github.com/JayanAXHF/templatex/pull/10))
