...
## [0.3.0](https://github.com/JayanAXHF/templatex/compare/v0.2.0...v0.3.0) - 2025-12-07

### Added

- *(templates)* [**breaking**] Added include, exclude and ignore options to templatex.toml files
- *(config)* Added support for custom themes

### Other

- *(CHANGELOG)* Changed CHANGELOG format
- Add GitHub Actions workflow for Rust project
- *(deps)* Updated CHANGELOG.md
