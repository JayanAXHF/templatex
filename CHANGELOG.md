...
## [0.4.0](https://github.com/JayanAXHF/templatex/compare/v0.3.0...v0.4.0) - 2025-12-08

### Added

- *(CLI)* Added an option for custom config_dir

### Fixed

- *(clippy)* removed unused import from templating.rs
